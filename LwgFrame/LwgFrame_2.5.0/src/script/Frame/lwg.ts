...
export module lwg {
    ...
    export module Gold {
        ...
        export function createGoldNode(x, y, parent?: Laya.Sprite): void {
            ...
            let sp: Laya.Sprite;
            Laya.loader.load('Prefab/Pregisterold.json', Laya.Handler.create(this, function (prefab: Laya.Prefab) {
                let _prefab = new Laya.Prefab();
                _prefab.json = prefab;
   ...
   */
    ...
    export module Admin {
       ...
       */
        ...
        export enum _SceneName {
            ...
            UIEasteregisterg = 'UIEasteregisterg',
            UIAds = 'UIAds',
            UILwgInit = 'UILwgInit',
            GameScene = 'GameScene',
        ...
        export class _Scene extends Laya.Script {
            ...
            // 常用零时变量
            point(str: string): Laya.Point { return this['str'] as Laya.Point; }
            number(): number { return this['str'] as number; }
    ...
    /**对游戏总的一些彩蛋进行管理*/
    export module Easteregisterg {
        /**彩蛋1任务集合*/
        export let _easteregisterg_1Arr: Array<any> = [];

        /**彩蛋1是否已经被触发*/
        export let _easteregisterg_1 = {
            get value(): boolean {
        ...
        /**彩蛋1是否达成*/
        export let _easteregisterg_1Complete: boolean;

        /**初始化彩蛋模块*/
        export function initEasteregisterg(): void {
            _easteregisterg_1Arr = Tools.jsonCompare("GameData/Easteregisterg/Easteregisterg.json", Classify.Easteregisterg_01, Property.name);
        ...
        */
        ...
        export enum Classify {
            Easteregisterg_01 = 'Easteregisterg_01',
        }
        ...
        export enum EventType {
            ...
            trigger = 'trigger',
            /**看广告完成任务*/
            easteregistergAds = 'easteregistergAds',
        }

        /**彩蛋场景继承类*/
        export class EasteregistergScene extends Admin._Scene {
            moduleOnAwake(): void {
            }
            /**初始化json数据*/
            moduleOnEnable(): void {
